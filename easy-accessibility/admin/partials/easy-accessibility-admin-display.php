	...
	<h2 class="nav-tab-wrapper"><?php _e('Login customization', $this->plugin_name);?></h2>
			...
			<!-- add your logo to login -->
				<fieldset>
					...
					<div id="upload_logo_preview" class="easy_accessibility-upload-preview <?php if(empty($login_logo_id)) echo 'hidden'?>">
						<img src="<?php echo $login_logo_url; ?>" />
						<button id="easy_accessibility-delete_logo_button" class="easy_accessibility-delete-image">X</button>
					</div>
				</fieldset>

			<!-- login background color-->
				<fieldset class="easy_accessibility-admin-colors">
